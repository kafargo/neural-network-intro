...
# This script fixes the imports in the api_server.py file and runs the server

# Navigate to project directory
cd "$(dirname "$0")"

# First, fix the imports in the api_server.py file
cat > src/api_server.py.new << 'EOF'
"""
api_server.py
~~~~~~~~~~~~~~~~~
...
mv src/api_server.py.new src/api_server.py
...
# Display access information before starting server
